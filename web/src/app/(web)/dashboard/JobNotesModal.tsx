      ...
      <Dialog.Panel className="max-h-[95vh] w-[45ch] max-w-full overflow-hidden rounded-lg bg-zinc-50 shadow-lg">
        <div className="relative flex max-h-[inherit] min-h-[45ch] max-w-full flex-col overflow-y-auto overflow-x-hidden">
          <div className="flex flex-grow flex-col p-4">
            <div className="z-10 flex w-full flex-col items-end rounded-lg border-2 bg-white p-4">
            ...
            <div className="flex max-h-[50vh] flex-grow flex-col gap-2 overflow-auto rounded-b-lg py-4">
              {!notes?.length && (
